...
interface IDeliveryPartnerApplicationRejectedTemplate {
  firstName: string;
  businessName?: string;
  rejectionReason: string;
}

const deliveryPartnerApplicationRejectedTemplate = ({
  firstName,
  rejectionReason,
}: IDeliveryPartnerApplicationRejectedTemplate) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Your delivery partner application status update</title>
</head>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width: 540px; background: #ffffff; border-radius: 24px; overflow: hidden;">
          ...
          <tr>
            <td align="center" style="padding: 52px 40px 48px;">
              ...
              <h2 style="margin: 0 0 18px; font-size: 30px; line-height: 1.2; color: #111111;">Application update</h2>
              <p style="margin: 0 0 16px; font-size: 16px; line-height: 1.6; color: #333333;">Hi ${firstName}, we’re unable to approve your delivery partner application at this time.</p>
              <p style="margin: 0; font-size: 16px; line-height: 1.6; color: #333333;"><strong>Reason:</strong> ${rejectionReason}</p>
            </td>
          </tr>
        </table>
      </td>
...
export default deliveryPartnerApplicationRejectedTemplate;
